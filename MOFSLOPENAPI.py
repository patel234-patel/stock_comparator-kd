...
def GetPublicIPAddress():
    try:
        # PATCHED (vendored copy): upstream had no timeout here, so an
        # unreachable/slow checkip.dyndns.org could hang feed startup
        # indefinitely. Fails fast to the "1.2.3.4" fallback below instead.
        public_ip = get('http://checkip.dyndns.org/', timeout=5).text
